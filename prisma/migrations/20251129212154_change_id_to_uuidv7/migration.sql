/*
  ...
  Note: UUIDv7 is generated in the application layer via the 'uuidv7' npm package.
        For existing records during migration, we use gen_random_uuid() (UUIDv4) as a fallback.
*/

-- Step 1: Add a temporary column for the new UUID
ALTER TABLE "users" ADD COLUMN "new_id" UUID;

-- Step 2: Generate new UUIDs for existing records (using UUIDv4 as fallback during migration)
-- New records will use UUIDv7 generated by the application
